...
export const branches: Branch[] = [
  {
    ...
    color: "fest-orange",
    events: [
      { title: "AI Hackathon", category: "Technical", description: "Build AI-powered solutions in 24 hours", prizePool: "₹25,000", entryFee: "₹200", formLink: "https://forms.google.com", branch: "AI & DS", teamSize: "2-4 members", duration: "24 Hours", venue: "CS Lab 1", rules: ["Team size: 2-4 members", "Participants must bring their own laptops", "Pre-built models are not allowed", "Internet access will be provided", "Judging based on innovation, feasibility, and presentation", "Decision of judges is final"] },
