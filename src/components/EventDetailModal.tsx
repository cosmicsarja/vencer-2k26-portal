          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
            ...
            {event.rulebook && (
              <a
                href={event.rulebook}
                download
                className="flex items-center justify-center gap-2 w-full font-display text-xs sm:text-sm tracking-wider px-6 py-3 rounded-xl bg-primary/10 text-primary border-2 border-primary/40 font-bold hover:bg-primary/20 hover:shadow-[0_0_20px_hsl(var(--fest-teal)_/_0.2)] transition-all duration-300 hover:scale-[1.02]"
              >
                <Download size={16} />
