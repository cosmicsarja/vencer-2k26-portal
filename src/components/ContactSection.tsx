      ...
      <div className="container px-3 sm:px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 max-w-5xl mx-auto mb-10 sm:mb-12">
          {[
            ...
            { icon: Phone, label: "Phone", value: "0831-2438100/123", href: "tel:+91831-2438100" },
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 max-w-5xl mx-auto mb-10 sm:mb-12">
          {[
            {
              branch: "Event / Cultural Coordinator",
              role1: "Event Coordinator",
              coord1: "Ayshwrya B",
              phone1: "+91 86609 73548",
              role2: "Cultural Coordinator",
              coord2: "Rudragouda P",
              phone2: "+91 97435 19483",
            },
            {
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1, duration: 0.5 }}
              className="glass glass-hover rounded-xl p-3 sm:p-5 text-center transition-all duration-500 block"
            >
              ...
              <div className="space-y-1 text-left">
                <div title={branchItem.role1 ? `${branchItem.role1} - ${branchItem.coord1}` : undefined}>
                  <div className="font-semibold text-[11px] sm:text-xs text-foreground leading-tight pb-0.5">{branchItem.role1 ? `${branchItem.role1} - ` : "1. "}{branchItem.coord1}</div>
                ...
                <div title={branchItem.role2 ? `${branchItem.role2} - ${branchItem.coord2}` : undefined}>
                  <div className="font-semibold text-[11px] sm:text-xs text-foreground leading-tight pb-0.5">{branchItem.role2 ? `${branchItem.role2} - ` : "2. "}{branchItem.coord2}</div>
