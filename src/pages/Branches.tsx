...
const tribes = [
  ...
  { clanName: "Robo Guardian Clan", icon: Bot, biome: "Robo Frontier", accent: "fest-red", glowVar: "--fest-red", gradient: "from-fest-red/20 via-fest-ember/10 to-transparent", borderGlow: "hover:shadow-[0_0_30px_hsl(var(--fest-red)_/_0.35)]", desc: "Builders of sentient machines — commanding steel and code to create autonomous warriors.", filterColor: "0 90% 55%" },
