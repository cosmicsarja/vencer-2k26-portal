...
const tribes = [
  ...
  { clanName: "Robo Guardian Clan", icon: Bot, biome: "Robo Frontier", accent: "fest-yellow", glowVar: "--fest-yellow", gradient: "from-fest-yellow/20 via-fest-orange/10 to-transparent", borderGlow: "hover:shadow-[0_0_30px_hsl(var(--fest-yellow)_/_0.35)]", desc: "Builders of sentient machines — commanding steel and code to create autonomous warriors.", filterColor: "45 85% 55%" },
